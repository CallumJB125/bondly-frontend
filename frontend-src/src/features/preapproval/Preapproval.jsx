...
const SPEND_META = {
  ...
  dining_out:       { icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/><line x1="6" y1="1" x2="6" y2="4"/><line x1="10" y1="1" x2="10" y2="4"/><line x1="14" y1="1" x2="14" y2="4"/></svg>, label: 'Dining & Restaurants' },
  medical:          { icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>, label: 'Medical & Health' },
  online_shopping:  { icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg>, label: 'Online Shopping' },
  education:        { icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>, label: 'Education & Fees' },
  domestic:         { icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>, label: 'Domestic Worker' },
  gambling:         { icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="2"/><circle cx="8" cy="8" r="1.5" fill="currentColor"/><circle cx="16" cy="8" r="1.5" fill="currentColor"/><circle cx="8" cy="16" r="1.5" fill="currentColor"/><circle cx="16" cy="16" r="1.5" fill="currentColor"/><circle cx="12" cy="12" r="1.5" fill="currentColor"/></svg>, label: 'Gambling' },
  atm:              { icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>, label: 'Cash Withdrawals' },
  bank_fees:        { icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>, label: 'Bank Fees' },
...
const STEPS = ['Quick estimate', 'Bank statement (optional)', 'Review your details', 'Your result'];
...
const STEP_DESCRIPTIONS = [
  ...
  'Upload your statement for higher accuracy — or skip to enter manually',
...
export default function Preapproval() {
  ...
  const [form, setForm] = useState({
    income: '', debt: '', deposit: '',
    name: '', phone: '', email: '', contact: 'WhatsApp',
    maritalStatus: '',
    marriageType: '',
      ...
      <div className="fade-in">
        ...
        <div style={{ display: 'grid', gap: 'var(--space-4)', marginBottom: 'var(--space-4)' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-3)' }}>
            ...
            <div>
              <label style={{ display: 'block', fontWeight: 600, fontSize: '0.875rem', marginBottom: 6 }}>
                Monthly debt payments <span style={{ fontWeight: 400, color: 'var(--text-secondary)', fontSize: '0.8125rem' }}>(optional)</span>
              </label>
              <input
                type="number"
        ...
        {estimate > 0 && (
          <div className="fade-in" style={{ background: 'var(--forest)', borderRadius: 12, padding: '24px 28px', marginBottom: 'var(--space-5)', textAlign: 'center' }}>
            <div style={{ color: 'rgba(245,240,232,0.6)', fontSize: '0.8125rem', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 8 }}>
              You could qualify for up to
            </div>
            <div style={{ color: 'var(--lime)', fontWeight: 800, fontSize: '2.5rem', fontFamily: 'var(--font-serif)', marginBottom: 4 }}>
              {fmt(estimate)}
            </div>
            <div style={{ color: 'rgba(245,240,232,0.55)', fontSize: '0.875rem' }}>
              ≈ {fmt(monthly)}/month at prime ({livePrime}%) · 20-year term
            </div>
            <div style={{ marginTop: 16, padding: '10px 16px', background: 'rgba(255,255,255,0.07)', borderRadius: 8, fontSize: '0.8125rem', color: 'rgba(245,240,232,0.6)', lineHeight: 1.5 }}>
        ...
        {incomeVal > 0 && (
          <a
            href={`https://wa.me/27796971786?text=${encodeURIComponent(
              `Hi Bondly, I checked my affordability on bondly.co.za. Monthly income: R ${incomeVal.toLocaleString('en-ZA')}/mo — the calculator shows I could qualify for approximately R ${estimate.toLocaleString('en-ZA')}. I'd like to continue my pre-approval.`
            )}`}
            className="pa-whatsapp-cta"
            target="_blank"
            rel="noreferrer"
          >
            ...
            Save my estimate — continue on WhatsApp →
          </a>
        )}
  ...
  function renderStep1() {
    ...
    return (
      <div className="fade-in">
        <h1 className="preapproval-title">Upload your bank statement — AI analyses it in 1–2 minutes</h1>
        <p className="preapproval-sub">
        ...
        <p className="pa-stmt-optional-hint">Optional — upload improves accuracy but you can skip and enter your income manually.</p>
        ...
        <button
          ...
          onClick={() => {
            setStep(2);
            setSkippedSteps(prev => new Set([...prev, 1]));
          }}
          type="button"
        >
    ...
    return (
      <div className="fade-in">
        ...
        {zone && (
          <>
            ...
            {typeof readiness?.score === 'number' && (
              <div className={`pa-likelihood ${
                readiness.score >= 70 ? 'pa-likelihood--green' :
                readiness.score >= 45 ? 'pa-likelihood--amber' :
                'pa-likelihood--red'
              }`}>
                {readiness.score >= 70 && <><strong>5–7 of 7 banks</strong> likely to approve your application</>}
                {readiness.score >= 45 && readiness.score < 70 && <><strong>3–5 of 7 banks</strong> may consider your application</>}
                {readiness.score < 45 && <><strong>1–3 banks</strong> may need more information — see improvements below</>}
              </div>
            )}
        ...
        <div className="pa-bond-summary">
          ...
          {dep > 0 && bondAmt > 0 && (
            <>
              <div className="pa-bond-summary__divider" />
              <div className="pa-bond-summary__item">
                <div className="pa-bond-summary__label">Bond + deposit budget</div>
        ...
        <div className="pa-results-sticky-cta">
          {zone?.zone === 'red' || bondAmt === 0
            ? <Button variant="ghost" full onClick={() => navigate('/optimize')}>Review my finances →</Button>
            : <Button variant="lime" full onClick={() => { trackAction('preapproval_cta_clicked', { step: 3 }); setStep(4); }}>Get pre-approved — it's free →</Button>
          }
        </div>
  ...
  async function submit() {
    ...
    if (!form.maritalStatus) { showToast('Please select your marital status', 'error'); return; }
    if (form.maritalStatus === 'Married' && !form.marriageType) {
      showToast('Please select your marriage type (in/out of community of property)', 'error');
      return;
    }
    setSubmitting(true);
    try {
      ...
      <div className="fade-in">
        ...
        <div style={{ fontSize: '0.8125rem', color: 'var(--text-secondary)', marginBottom: 'var(--space-3)', padding: '10px 14px', background: 'var(--bg-page)', borderRadius: 8, border: '1px solid var(--border-color)' }}>
          ...
          <ol style={{ margin: 0, paddingLeft: 18, lineHeight: 1.7 }}>
            <li>We match you with a partner bond originator</li>
            <li>They contact you within 48 hours</li>
        ...
        <div className="container container--narrow">
          ...
          <div className="prequal-cert fade-in">
            ...
            <div className="prequal-cert__body">
              ...
              {bondAmt > 0 ? (
                <>
                  <div className="prequal-cert__amount">{fmt(bondAmt)}</div>
                  <div className="prequal-cert__words">{numberToWords(bondAmt).toUpperCase()}</div>
                </>
              ) : (
              ...
              <div className="prequal-cert__details">
                ...
                <div className="prequal-cert__detail-row">
                  ...
                  <strong>{analysis ? '✓ Bank statement verified' : 'Self-declared'}</strong>
                </div>
                <div className="prequal-cert__detail-row">
          ...
          {bondAmt > 0 && (
            <div className="pa-stage2-cta no-print fade-in">
              ...
              <Button variant="lime" onClick={() => isLoggedIn ? setStep('apply') : navigate('/register?intent=apply')}>
                Submit to banks
              </Button>
            </div>
          )}
