      ...
      <div className="mr-page">
        <div className="container mr-inner">
          ...
          <div className="mr-header">
            ...
            <h1 className="mr-header__title">Can I afford<br />a home loan?</h1>
            <p className="mr-header__sub">
              Enter your income or upload a bank statement. We calculate <strong>how much you could borrow</strong> the way banks do — instantly, for free, and we'll tell you if you're better off building first.
            </p>
          </div>
          ...
          {mode === 'manual' && (
            <div className="mr-form fade-in">
              ...
              {!afford && (
                <p className="mr-form__hint">Enter your income above to see how much you could borrow.</p>
              )}
            </div>
          )}
            ...
            <div className="mr-results fade-in">
              ...
              <div className="mr-funnel">
                ...
                <div className="mr-funnel__cards">
                  {hasStatementResult ? (
                    /* Statement analysed — ready to apply via broker team */
                    <button className="mr-funnel__card mr-funnel__card--primary" onClick={goToPreapproval}>
                      ...
                      <div>
                        <div className="mr-funnel__card-title">Submit for a bond review — free</div>
                        <div className="mr-funnel__card-desc">Our broker team takes your application to the SA banks they believe will offer you the best rate (typically 3–5 of the major lenders). You hear back within 3–10 business days.</div>
                      </div>
                    </button>
                  ) : (
                    /* Manual entry only — nudge to upload for accuracy */
                    <button className="mr-funnel__card mr-funnel__card--primary" onClick={() => setMode('statement')}>
                      <div className="mr-funnel__card-icon"><ArrowRight size={20} /></div>
                      <div>
                        <div className="mr-funnel__card-title">Get an accurate result — upload your statement</div>
                        <div className="mr-funnel__card-desc">Your income estimate gives a rough range. Upload a bank statement and Bondly analyses your actual finances — income, debts, and spending — to give you a real approval verdict.</div>
                      </div>
                    </button>
                  )}
