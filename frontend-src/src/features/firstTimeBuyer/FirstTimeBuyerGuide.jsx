          ...
          <section className="ftb-section">
            ...
            <ul className="ftb-list">
              <li>
                ...
                <em> Homes under R 1.1 million are exempt.</em> Above R 1.1m you pay between 3% and 13% of the price (the bands get steeper as the price goes up). On a R 1.5m home: about R 12 000.
              </li>
              <li>
